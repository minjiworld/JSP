...
<body>
	...
	<section id="articleForm">
		...
		<section id="basicInfoArea">
			<table border="1">
			<tr><th width="70">제 목</th><td colspan="3" >${bean.board_subject}</td></tr>
			<tr>
				<th width="70">작성자</th><td>${bean.board_name }</td>
				<th width="70">작성일</th>
				<td><fmt:formatDate value="${bean.board_date }" pattern="yy-MM-dd HH:mm:SS"/>
				</td>
			</tr>
			<tr>
				<th width="70">첨부파일</th>
				<td>
				<a href="upload/${bean.board_real_file }" 
					download="${bean.board_file }">
					${bean.board_file }</a>
				</td>
				<th width="70">조회수</th>
